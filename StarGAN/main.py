...
if __name__ == '__main__':
    ...
    parser.add_argument('--celebA_crop_size', type=int, default=1024)
    ...
    # Path
    parser.add_argument('--celebA_image_path', type=str, default='/home/khsunkh/kihong/trash/data_center')
    parser.add_argument('--rafd_image_path', type=str, default='./data/RaFD/train')
    parser.add_argument('--metadata_path', type=str, default='/home/khsunkh/data_center/list_attr_data_center.txt')
    ...
    parser.add_argument('--sample_step', type=int, default=150) #500
    parser.add_argument('--model_save_step', type=int, default=150) #1000
